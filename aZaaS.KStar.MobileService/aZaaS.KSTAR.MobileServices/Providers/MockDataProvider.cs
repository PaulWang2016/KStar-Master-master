...
{
    public class MockDataProvider : BaseDataProvider
    {
                ...
                task = new Task()
                {
                    BaseInfo = new BaseInfo()
                    {
                        Items = new List<Item>()
                        {
                            ...
                            new Item(){Name="StartDate", Value=now.AddMinutes(-i).ToString("yyyy MM dd hh:mm:ss")},
                ...
                task = new Task()
                {
                    BaseInfo = new BaseInfo()
                    {
                        Items = new List<Item>()
                        {
                            ...
                            new Item(){Name="StartDate", Value=now.AddDays(-1).AddMinutes(-i).ToString("yyyy MM dd hh:mm:ss")},
                            new Item(){Name="Summary", Value="Summary " + i.ToString()}
                        }
                    },
                    ExtendInfo = new ExtendInfo() { }
                ...
                task = new Task()
                {
                    BaseInfo = new BaseInfo()
                    {
                        Items = new List<Item>()
                        {
                            ...
                            new Item(){Name="StartDate", Value=now.AddDays(-5).AddMinutes(-i).ToString("yyyy MM dd hh:mm:ss")},
                            new Item(){Name="Summary", Value="Summary " + i.ToString()}
                        }
                    },
