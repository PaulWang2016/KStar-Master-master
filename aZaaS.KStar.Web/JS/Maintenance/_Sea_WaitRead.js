define(function (require, exports, module) {
    ...
    var CCToMeColumns = [
        ...
        { field: "ProcessFolio", title: jsResxMaintenance_SeaWaitRead.ProcSubject,width:300, filterable: false, sortable: false },
    ...
    var SearchCCToMe = function (searchkey, isAjax) {       
        //showOperaMask();
        //InitServerQueryKendoExcelGrid("dataList", myCCModel, CCToMeColumns, "/Maintenance/MyFormCC/FormCCToMe", searchkey, $(window).height() - fullwidgetH,jsResxMaintenance_SeaWaitRead.GridHeader,
        //  function () {
        ...
        $.ajax({
            ...
            success: function (items) {
                InitKendoExcelGridWithHeight("dataList", myCCModel, CCToMeColumns, items, 20, jsResxMaintenance_SeaWaitRead.GridHeader, $(window).height() - fullwidgetH,
                    function () {
                        bindAndLoad("dataList")
                    });
            },
    ...
    var SearchClick = function () {
        ...
        var searchkey = { startDate: start, endDate: end, formSubject: formSubject, processName: processName, receiveStatus: 0, "_t": new Date() };
