...
namespace aZaaS.KStar.Web.Utilities
{
    ...
    public static partial class Excel
    {
        ...
        {
            return SetColumnHeadingValue(spreadsheet, worksheet, columnIndex, 1, stringValue, useSharedString, save);
        }
        /// <summary>
        ...
        /// <returns>True if succesful</returns>
        public static bool SetColumnHeadingValue(DocumentFormat.OpenXml.Packaging.SpreadsheetDocument spreadsheet, DocumentFormat.OpenXml.Spreadsheet.Worksheet worksheet, uint columnIndex, uint rowIndex, string stringValue, bool useSharedString, bool save = true)
        {
        ...
        /// <param name="worksheet">Worksheet to use</param>
        /// <param name="columnIndex">Index of the column</param>
        /// <param name="hidden">Hidden to set</param>
        /// <returns>True if succesful</returns>
        public static bool SetColumnHidden(DocumentFormat.OpenXml.Spreadsheet.Worksheet worksheet, int columnIndex, bool hidden)
        {
            DocumentFormat.OpenXml.Spreadsheet.Columns columns;
            DocumentFormat.OpenXml.Spreadsheet.Column column;
        ...
        /// <summary>
        /// Sets the column OutlineLevel
        /// </summary>
        /// <param name="worksheet">Worksheet to use</param>
        /// <param name="rowIndex">Index of the row</param>
        /// <param name="outlineLevel">OutlineLevel to set</param>
        /// <returns></returns>
        public static bool SetRowOutlineLevel(DocumentFormat.OpenXml.Spreadsheet.Worksheet worksheet, int rowIndex, int outlineLevel)
        {
            ...
            row.OutlineLevel = DocumentFormat.OpenXml.ByteValue.FromByte(System.Convert.ToByte(outlineLevel - 1));
            return true;
        }
        /// <summary>
        /// Merge Cell of Row
        ...
        /// <param name="rowIndex">Index of the row</param>
        /// <returns></returns>
        public static bool MergeCellofRow(DocumentFormat.OpenXml.Spreadsheet.Worksheet worksheet, int rowIndex)
        {
            MergeCells mergeCells;
            #region 获取 或 初始化 mergeCells
            ...
            DocumentFormat.OpenXml.Spreadsheet.Row row;
            row = sheetData.Elements<DocumentFormat.OpenXml.Spreadsheet.Row>().Where(item => item.RowIndex == rowIndex).First();
            var FirstCell = row.FirstChild as DocumentFormat.OpenXml.Spreadsheet.Cell;
            var LastCell = row.LastChild as DocumentFormat.OpenXml.Spreadsheet.Cell;
            MergeCell mergeCell = new MergeCell() { Reference = new DocumentFormat.OpenXml.StringValue(FirstCell.CellReference + ":" + LastCell.CellReference) };
