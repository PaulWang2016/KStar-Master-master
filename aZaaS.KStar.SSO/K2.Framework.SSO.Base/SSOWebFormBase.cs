...
{
    public class SSOWebFormBase : System.Web.UI.Page
    {
        ...
        public static void GetToken(System.Web.UI.Page controller)
        {
        ...
        /// </summary>
        /// <param name="controller"></param>
        public static string GetTokenByUserAccount(System.Web.UI.Page controller)
        {
            if (controller.Session[SSOWebFormBase.Token] == null)
            {
                if (controller.Request.QueryString["token"] != null)
             ...
             if (Session["Token"] == null)
            {
                ...
                if (Request.QueryString["token"] != null)
                {
                    if (Request.QueryString["token"] != Utilities.TokenReplace)
                    {
                        ...
                        {
                            //Token错误 
                            this.Response.Redirect(SSOWebFormBase.ReplaceToken(this));
                        }
                    }
                    else
                    {
                ...
                {
                    this.Response.Redirect(GetTokenURL(this));
                }
            }
            base.OnPreInit(e);
        } 
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetTokenURL(System.Web.UI.Page controller)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static string ReplaceToken(System.Web.UI.Page controller)
        {
            string url = controller.Request.Url.AbsoluteUri;
        ...
        protected void ClearToken()
        {
            try
            {
                ...
                Response.Redirect(LoginOutBase.getClearTokenURL(this.Request.Url.AbsolutePath));
            }
            catch
            {
            }
