...
{
    public class NeoWaySSOLogin : ISSOLogin
    {
        public Controller CurrentController = null;
        private NeoWaySSOLogin() { }

        public NeoWaySSOLogin(Controller controller) { this.CurrentController = controller; }
        ...
        private JsonResult OuterNetworkLogin(LoginModel model, LoginUser _user)
        {
            ...
            {
                model.Account = ConfigurationManager.AppSettings["DefaultDomain"].ToString() + @"\" + model.Account;
            }
